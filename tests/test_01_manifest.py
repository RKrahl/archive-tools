...
testdata = [
    TestDataDir(Path("base"), 0o755, mtime=1564333266),
    TestDataDir(Path("base", "data"), 0o750, mtime=1564333266),
    TestDataDir(Path("base", "empty"), 0o755, mtime=1564333266),
    TestDataFile(Path("base", "msg.txt"), 0o644, mtime=1564333266),
    TestDataFile(Path("base", "data", "rnd.dat"), 0o600, mtime=1564333266),
