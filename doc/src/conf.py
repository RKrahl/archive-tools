...
"""
    github_repo = "https://github.com/RKrahl/archive-tools"
    dist_src_name = "archive-tools-%s.tar.gz" % last_release
    dist_src_url = ("%s/releases/download/%s/%s"
                    % (github_repo, last_release, dist_src_name))
    dist_sig_name = "archive-tools-%s.tar.gz.asc" % last_release
...
make_meta_rst(archive._meta.release)
